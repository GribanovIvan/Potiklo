...
mods.thaumcraft.Research.moveResearch("TRANSGEM", "ALCHEMY", 4, 3);
...
mods.thaumcraft.Research.moveResearch("FANCYLANTERN", "DYES", 0, 1);
mods.thaumcraft.Research.moveResearch("DECOMATRIX", "DYES", 0, 4);
